...
import { SongSearchInput, SongCard } from '.';
  ...
  return (
    <OnboardingLayout currentStep={6}>
      <div className="space-y-6 animate-in fade-in duration-500">
          <div>
            <h2 className="text-3xl font-bold text-foreground">Show us your album</h2>
            <p className="text-sm text-muted-foreground mt-2">Input your top 6 soundtracks in order - your personal music journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-8">
            ...
            >
              ...
              <span className="text-base font-normal text-foreground">Add Your Top Soundtrack</span>
            </button>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col border-0 bg-card">
                <DialogHeader className="px-6 pt-6">
                  <DialogTitle className="text-xl font-semibold text-foreground">Search for Your Top Soundtracks</DialogTitle>
                </DialogHeader>
                  ...
                  <Controller
                    ...
                    render={() => (
                      <SongSearchInput
                        ...
                        placeholder="Search for your favorite music tracks..."
                      />
                    )}
                  />
                  ...
                  {!searchQuery && searchResults.length === 0 && (
                    <div className="text-center py-12">
                      <p className="text-muted-foreground text-sm">
                        Start typing to search for your favorite music tracks
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  {selectedSongs.map((song, index) => (
                    <div key={song.id} className="flex items-center gap-4">
                      ...
                      {song.albumCoverUrl ? (
                        ...
                        <div className="w-24 h-24 rounded bg-secondary flex-shrink-0" />
                      )}
            ...
            <div className="flex justify-end items-center gap-4 pt-4">
              ...
              >
                {selectedSongs && selectedSongs.length > 0 ? 'Complete Your Album' : 'Skip'}

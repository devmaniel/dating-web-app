...
export interface InterestSearchInputProps {
  value: string;
  onChange: (value: string) => void;
  placeholder?: string;
}

export const InterestSearchInput = forwardRef<HTMLInputElement, InterestSearchInputProps>(
  ({ value, onChange, placeholder = 'Search Interest' }, ref) => {
    return (
...
InterestSearchInput.displayName = 'InterestSearchInput';

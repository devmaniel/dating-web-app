...
import { FirstNameInput, MiddleNameInput, LastNameInput, BirthdateInputs, GenderButtons } from './components/step-1';
    ...
    <OnboardingLayout currentStep={1}>
      <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            <div className="space-y-1.5">
              <label className="text-base font-medium text-foreground">Your Birthdate</label>
              <Controller
                name="birthdate"
                control={control}
                render={({ field }) => (

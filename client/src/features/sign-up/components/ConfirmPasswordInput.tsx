...
export const ConfirmPasswordInput = forwardRef<HTMLInputElement, ConfirmPasswordInputProps>(
  (props, ref) => {
    return (
      <div className="relative flex text-background items-center bg-gray-200 rounded-md border border-transparent hover:bg-white hover:border-gray-900 focus-within:bg-white focus-within:border-gray-900 transition-colors h-12">
